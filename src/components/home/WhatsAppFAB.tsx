  ...
  return (
    ...
    >
      <Link
        ...
        className="group relative flex items-center gap-3 bg-gradient-to-r from-[#25D366] to-[#128C7E] hover:from-[#128C7E] hover:to-[#075E54] text-white pl-4 pr-5 py-3 rounded-full shadow-[0_8px_24px_rgba(37,211,102,0.4)] hover:shadow-[0_12px_32px_rgba(37,211,102,0.6)] hover:-translate-y-1 active:scale-95 transition-all duration-500 overflow-hidden"
      >
        ...
        <div className="relative flex items-center justify-center">
          ...
          <svg viewBox="0 0 24 24" className="w-5 h-5 fill-white flex-shrink-0 relative z-10" aria-hidden="true">
        ...
        <span className="text-sm font-black tracking-wide drop-shadow-sm relative z-10">WhatsApp Order</span>
      </Link>
    </motion.div>
  )
}
