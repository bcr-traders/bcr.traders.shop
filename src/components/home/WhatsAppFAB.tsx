  ...
  return (
    ...
    >
      <Link
        ...
        className="flex items-center gap-2 bg-[#25D366] text-white pl-3 pr-4 py-2.5 rounded-full shadow-lg hover:shadow-xl hover:scale-105 active:scale-95 transition-all duration-200"
      >
        {/* WhatsApp icon */}
        ...
        <span className="text-sm font-bold">WhatsApp Order</span>
      </Link>
    </motion.div>
  )
}
